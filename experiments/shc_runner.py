...
from botorch.test_functions.synthetic import SixHumpCamel
from math import pi
...
def obj_func(X: Tensor) -> Tensor:
    X_unnorm = X.clone()
    X_unnorm[..., 0] = 6.0 * X_unnorm[..., 0] - 3.0
    X_unnorm[..., 0] = 4.0 * X_unnorm[..., 0] - 2.0
    six_hump_camel = SixHumpCamel()
    objective_X = -six_hump_camel.evaluate_true(X_unnorm)
    return objective_X
